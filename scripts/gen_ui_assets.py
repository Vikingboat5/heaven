...
ASSETS = {
    ...
    # 日记本 (主页日记入口, 场景实物): 合上的实心皮书, 小尺寸可读性优先
    "icon_book": f"一本合上的旅行日记本, 厚实的暖棕色皮质封面, 封面上插着一根白色羽毛笔, 侧面露出米色书页边, {STYLE}, 居中, 纯白色背景, 无阴影无发光, 无文字",
    # 出门告示牌 (旅行中立在空地上): 木桩+横向空白牌面
    "sign_post": f"一块插在草地上的木质小告示牌, 细木桩竖直插入土中, 上方一块横向圆角空白牌面, 温润蜂蜜色木纹, {STYLE}, 居中, 纯白色背景, 无阴影无发光, 无文字",
    # 小窝 (底部导航 tab): 侧前方视角+厚实暖棕, 与背包/书本/篮子同一质感体系
    "icon_home": f"一个温暖的干草编小窝巢, 侧前方视角, 厚实的暖棕色干草质感, 巢里垫着柔软的白羽毛, 巢沿插着一朵小粉花, {STYLE}, 居中, 纯白色背景, 无阴影无发光, 无文字",
    # 软木墙背景 (明信片墙页用)
    "cork_board": f"一块软木塞材质的布告板纹理, 密集的小颗粒质感, 暖棕色调, 平铺四方连续纹理, {STYLE}, 无文字, 无图钉",
}
