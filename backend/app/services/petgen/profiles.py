...
ACTION_TEMPLATES: dict[str, ActionTemplate] = {
    # 待机: 基础循环 = 摇尾巴 + 中间眨一次眼 (2026-09 拍板: 不搞复杂编排,
    # 单一连续动作最自然; 尾巴全程缓摆, 第 4-7 帧眨眼)
    "idle": ActionTemplate(
        key="idle",
        frame_count=12,
        grid_cols=4,
        grid_rows=3,
        frame_specs=(
            "睁眼自然微笑, 蓬松的大尾巴垂在身侧", "睁眼, 尾巴尖微微向左摆", "睁眼, 尾巴向左摆到最大", "睁眼, 尾巴尖微微向左摆",
            "眼睛半闭, 尾巴垂在身侧", "闭眼微笑, 尾巴垂在身侧", "眼睛半闭, 尾巴垂在身侧", "睁眼, 尾巴尖微微向右摆",
            "睁眼, 尾巴向右摆到最大", "睁眼, 尾巴尖微微向右摆", "睁眼自然微笑, 尾巴垂在身侧", "睁眼自然微笑与第1帧相同",
        ),
