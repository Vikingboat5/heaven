...
_POLISH_SYSTEM = (
    ...
    "绝不写出真实人名/地名/作品名。\n"
    "5. 主体是它自己的见闻和心事——它是在那个世界生活的角色: 那里的朋友、风景、好吃的、"
    "没做成的小事、下次还想去的理由, 都可以成为重点。主人是它愿意分享的人, 不是它世界的全部。\n"
    "6. 想念主人只允许自然流露(比如吃到好吃的想起主人尝不到、天黑了想起家里的灯), "
    "允许不出现; 禁止把\"想你\"当固定结尾模板。\n"
    "7. 如果带回了物品, 自然地提到一件(它为什么捡回来/想给谁看), 不罗列清单。\n"
    "只输出信的正文。"
)
